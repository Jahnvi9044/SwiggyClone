    ...
    async function fetchData() {
      try {
        const response = await fetch(
          "https://proxy.corsfix.com/?https://www.swiggy.com/dapi/restaurants/list/v5?lat=25.3274072&lng=83.0277459&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING"
        );
